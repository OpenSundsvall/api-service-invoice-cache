...
public class InvoiceCacheIT extends AbstractInvoiceCacheAppTest {
    ...
    void test1_findByOrganizationNumber() {
        ...
        setupCall()
                .withServicePath("/getInvoices?page=1&limit=100&partyIds=fb2f0290-3820-11ed-a261-0242ac120002&partyIds=fb2f0290-3820-11ed-a261-0242ac120003")
    ...
    void test2_findByOrgNumberAndDatesWithPaging_shouldFindBetweenDates() {
        ...
        assertThat(invoiceDb.isRunning()).isTrue();
        setupCall()
                .withServicePath("/getInvoices?page=1&limit=10&invoiceDateFrom=2022-08-06&invoiceDateTo=2022-09-10&partyIds=fb2f0290-3820-11ed-a261-0242ac120002")
                .withHttpMethod(HttpMethod.GET)
                .withExpectedResponseStatus(HttpStatus.OK)
                .withExpectedResponse("expected.json")
                .sendRequestAndVerifyResponse();
    ...
    void test3_findSingleInvoiceUsingAllFields_shouldFindByCriterias() {
        ...
        assertThat(invoiceDb.isRunning()).isTrue();
        setupCall()
                .withServicePath("/getInvoices?page=1&limit=100&invoiceDateFrom=2022-01-01&invoiceDateTo=2022-12-31&dueDateFrom=2022-09-10&dueDateTo=2022-09-10&partyIds=fb2f0290-3820-11ed-a261-0242ac120002&ocrNumber=34563464&invoiceNumbers=53626804")
                .withHttpMethod(HttpMethod.GET)
                .withExpectedResponseStatus(HttpStatus.OK)
                .withExpectedResponse("expected.json")
                .sendRequestAndVerifyResponse();
    ...
    void test4_noInvoiceFound_shouldReturnEmptyList() {
        ...
        assertThat(invoiceDb.isRunning()).isTrue();
        setupCall()
                .withServicePath("/getInvoices?page=1&limit=100&invoiceDateFrom=2022-08-09&invoiceDateTo=2022-08-09&partyIds=fb2f0290-3820-11ed-a261-0242ac120002&ocrNumber=34563464&invoiceNumber=53626804")
                .withHttpMethod(HttpMethod.GET)
                .withExpectedResponseStatus(HttpStatus.OK)
                .withExpectedResponse("expected.json")
                .sendRequestAndVerifyResponse();
    ...
    void test5_searchInvoice_withoutPartyID_shouldReturnWithoutPartyId() {
        ...
        assertThat(invoiceDb.isRunning()).isTrue();
        setupCall()
                .withServicePath("/getInvoices?page=1&limit=100&invoiceDateFrom=2022-01-01&invoiceDateTo=2022-12-31&invoiceNumbers=53626800")
                .withHttpMethod(HttpMethod.GET)
                .withExpectedResponseStatus(HttpStatus.OK)
                .withExpectedResponse("expected.json")
                .sendRequestAndVerifyResponse();
